...
class Upload_crop_img
{
	...
	{  
		if(!strpos($imagename,'logo.png') && !strpos($imagename,'com-soon.jpg')):
			$thumbpath		=	str_replace(base_url(),FCPATH,trim($imagename));
	...
	{  
		if(!strpos($imagename,'logo.png') && !strpos($imagename,'com-soon.jpg')):
			$imagepath		=	str_replace(base_url(),FCPATH,$imagename);
	...
	{	
		...
		switch($type):
			case 'profileImage':
				$data['original']	= 	array("path"=>"./assets/profileImage/","allowed_types"=>"gif|jpg|png","max_size"=>"20000","max_width"=>"","max_height"=>"", "thumb"=>TRUE);//Original
				$data['thumb']		= 	array("path"=>"./assets/profileImage/thumb/","allowed_types"=>"gif|jpg|png","source_path"=>"./assets/profileImage/","max_width"=>"50","max_height"=>"50");//Thumb
				$this->_check_directory($data['thumb']['path']);
			break;
			case 'productImage':
				$data['original']	= 	array("path"=>"./assets/productImage/","allowed_types"=>"gif|jpg|png","max_size"=>"20000","max_width"=>"","max_height"=>"", "thumb"=>TRUE);//Original
				$data['thumb']		= 	array("path"=>"./assets/productImage/thumb/","allowed_types"=>"gif|jpg|png","source_path"=>"./assets/productImage/","max_width"=>"220","max_height"=>"170");//Thumb
				$this->_check_directory($data['thumb']['path']);
			break;
			case 'propertyDocuments':
				$data['original']	= 	array("path"=>"./assets/propertyDocuments/","allowed_types"=>"gif|jpg|png","max_size"=>"20000","max_width"=>"","max_height"=>"");//Original
			break;
			case 'categoryImage':
				$data['original']	= 	array("path"=>"./assets/categoryImage/","allowed_types"=>"gif|jpg|png","max_size"=>"20000","max_width"=>"","max_height"=>"", "thumb"=>TRUE);//Original
				$data['thumb']		= 	array("path"=>"./assets/categoryImage/thumb/","allowed_types"=>"gif|jpg|png","source_path"=>"./assets/categoryImage/","max_width"=>"92","max_height"=>"92");//Thumb
				$this->_check_directory($data['thumb']['path']);
			break;
			case 'CMSpageimages':
				$data['original']	= 	array("path"=>"./assets/CMSpageimages/","allowed_types"=>"gif|jpg|png","max_size"=>"20000","max_width"=>"","max_height"=>"" ,"thumb"=>TRUE,"medium"=>TRUE);//Original
				$data['thumb']		= 	array("path"=>"./assets/CMSpageimages/thumb/","allowed_types"=>"gif|jpg|png","source_path"=>"./assets/CMSpageimages/","max_width"=>"150","max_height"=>"150");//Thumb
				$data['medium']		= 	array("path"=>"./assets/CMSpageimages/medium/","allowed_types"=>"gif|jpg|png","source_path"=>"./assets/CMSpageimages/","max_width"=>"50","max_height"=>"50");//medium
				$this->_check_directory($data['thumb']['path']);
				$this->_check_directory($data['medium']['path']);
			break;
			case 'propertyTypeImage':
				$data['original']	= 	array("path"=>"./assets/propertyTypeImage/","allowed_types"=>"gif|jpg|png","max_size"=>"20000","max_width"=>"","max_height"=>"");//Original
